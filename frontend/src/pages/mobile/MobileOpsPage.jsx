...
import { Users, Bus, Inbox, RefreshCw } from "lucide-react";
...
export default function MobileOpsPage({ defaultView = "delegates" }) {
  ...
  return (
    <div>
      ...
      {/* ---- Delegates / Exceptions / Trips switch ----------------------- *
       * Exceptions sits BETWEEN the other two on purpose: on the ground the
       * flow is "who's missing → raise/clear the issue → back to the coach",
       * so the inbox belongs next to the roster rather than at the far end.
       * ------------------------------------------------------------------ */}
