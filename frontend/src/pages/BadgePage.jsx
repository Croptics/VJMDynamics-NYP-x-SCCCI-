 ...
 *  Merged 2026-07-31 from Vance's post-v2 branch — see backend/routes/vance.js's
 *  GET /api/badge/:code (public) for the data this reads.
 * ============================================================================= */
...
export default function BadgePage() {
  ...
  useEffect(() => {
    let alive = true;
    fetch(`${API_BASE}/badge/${encodeURIComponent(code)}`)
